...
<head>
    ...
    <link rel="canonical" href="<?= e($config['app_url'] . ($_SERVER['REQUEST_URI'] ?? '/')) ?>">
    <meta property="og:title" content="<?= e($pageTitle) ?>">
    <meta property="og:description" content="<?= e($description ?? $config['site']['description']) ?>">
    <meta property="og:type" content="<?= !empty($schemaArticle) ? 'article' : 'website' ?>">
    <meta property="og:image" content="<?= e($config['app_url'] . ($post['og_image'] ?? $post['featured_image'] ?? asset('img/hero-portrait.png'))) ?>">
